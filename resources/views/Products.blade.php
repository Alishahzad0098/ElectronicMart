...
<body>
    ...
    <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="computer-tab" data-bs-toggle="tab"
                    data-bs-target="#computer-tab-pane" type="button" role="tab" aria-controls="computer-tab-pane"
                    aria-selected="true">Computers</button>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="headphone-tab" data-bs-toggle="tab" data-bs-target="#headphone-tab-pane"
                    type="button" role="tab" aria-controls="headphone-tab-pane"
                    aria-selected="false">Headphones</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="watches-tab" data-bs-toggle="tab" data-bs-target="#warches-tab-pane"
        ...
        <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="card text-center m-3" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('add.to.cart') }}" method="POST"
                                                ...
                                                <button type="submit" class="btn btn-primary add-to-cart-btn">Add To
                                                    Cart</button>
                                            </form>
                                        </div>
                                    </div>
            ...
            <div class="tab-pane fade" id="headphone-tab-pane" role="tabpanel" aria-labelledby="headphone-tab"
                tabindex="0">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row product-card-wrapper">
